        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          >
            ...
            <p className="text-lg text-gray-700 dark:text-gray-400 mb-10 max-w-lg leading-relaxed">
              A passionate <span className="text-purple-600 dark:text-purple-400 font-semibold">tech innovator</span> and <span className="text-blue-600 dark:text-blue-400 font-semibold">2X hackathon winner</span> from Indore, India, with expertise in web development, electronics, and leading technical teams to victory.
            </p>
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-transparent bg-gradient-to-r from-purple-600 via-pink-500 to-blue-500 p-1 shadow-2xl hover:shadow-purple-500/25 transition-all duration-300 float-animation">
              ...
              {/* Achievement badges */}
              <div className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full flex flex-col items-center justify-center animate-bounce shadow-xl">
